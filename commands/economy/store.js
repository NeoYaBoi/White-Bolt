...
exports.default = {
    ...
    callback: ({ member, user, prefix }) => {
        let embed = new discord_js_1.MessageEmbed()
            ...
            value: `\`\`${prefix}buy level 1\`\` | 💵 ${items_json_1.levels.one.price} ${config_json_1.currency}`
        }, {
            name: "> <:Level2:969799270435782656> Level 2",
            value: `\`\`${prefix}buy level 2\`\` | 💵 ${items_json_1.levels.two.price} ${config_json_1.currency}`
        }, {
            name: `> <:Level3:969799270347735081> Level 3`,
            value: `\`\`${prefix}buy level 3\`\` | 💵 ${items_json_1.levels.three.price} ${config_json_1.currency}`
        }, {
            name: `> <:Level4:969799270251237436> Level 4`,
            value: `\`\`${prefix}buy level 4\`\` | 💵 ${items_json_1.levels.four.price} ${config_json_1.currency}`
        }, {
            name: `> <:Level5:969799270427402340> Level 5`,
            value: `\`\`${prefix}buy level 5\`\` | 💵 ${items_json_1.levels.five.price} ${config_json_1.currency}`
        })
