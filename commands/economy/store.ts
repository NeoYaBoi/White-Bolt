        ...
        .addFields(
            {
                ...
                value: `\`\`${prefix}buy level 1\`\` | 💵 ${levels.one.price} ${currency}`
            }, {
            name: "> <:Level2:969799270435782656> Level 2",
            value: `\`\`${prefix}buy level 2\`\` | 💵 ${levels.two.price} ${currency}`
        }, {
            name: `> <:Level3:969799270347735081> Level 3`,
            value: `\`\`${prefix}buy level 3\`\` | 💵 ${levels.three.price} ${currency}`
        }, {
            name: `> <:Level4:969799270251237436> Level 4`,
            value: `\`\`${prefix}buy level 4\`\` | 💵 ${levels.four.price} ${currency}`
        }, {
            name: `> <:Level5:969799270427402340> Level 5`,
            value: `\`\`${prefix}buy level 5\`\` | 💵 ${levels.five.price} ${currency}`
        })
